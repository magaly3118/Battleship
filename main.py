...
def ship_placement_menu(player_grid, player_number, ship_list, ships_to_place):
    ...
    while placing_ships:
        win.fill(BLACK)
        draw_text(f"Player {player_number}: Place your ships", WIDTH // 2 - 150, 50)
        draw_text(f"Current ship length: {ships_to_place[ship_idx]}", WIDTH // 2 - 150, 100)
        draw_text("Press 'H' for Horizontal, 'V' for Vertical", WIDTH // 2 - 150, 150)
...
def main_menu():
    ...
    while menu_running:
        win.fill(BLACK)
        draw_text("Welcome to 2-Player Battleship", WIDTH // 2 - 150, HEIGHT // 2 - 100)
        ...
        draw_text("Press ENTER to start", WIDTH // 2 - 100, HEIGHT // 2 + 100)
...
def display_winner(winner):
    ...
    win.fill(BLACK)
    draw_text(f"Player {winner} Wins!", WIDTH // 2 - 100, HEIGHT // 2 - 50)
...
def display_turn_screen(player_number):
    ...
    win.fill(BLACK)
    draw_text(f"Player {player_number}'s Turn", WIDTH // 2 - 150, HEIGHT // 2 - 50)
...
def instructions_page():
    ...
    while instructions_running:
        ...
        draw_text("- Purple: Your ship", WIDTH // 2 - 300, 350)
        draw_text("- Grey: Missed shot", WIDTH // 2 - 300, 400)
        draw_text("- Red: Hit", WIDTH // 2 - 300, 450)
        draw_text("- Green: Sunk enemy ship", WIDTH // 2 - 300, 500)
        draw_text("- Blue: Sunk friendly ship", WIDTH // 2 - 300, 550)
        draw_text("Press ENTER to continue...", WIDTH // 2 - 100, HEIGHT - 100)
...
def game_loop():
    ...
    while running:
        ...
        if turn == 1:
            ...
            draw_text("Player 1's Turn", WIDTH // 2 - 100, 50)
